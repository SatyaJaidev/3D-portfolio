  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: "Satya Jaidev",
          from_email: form.email,
          to_email: "nsatyajaidev21@gmail.com",
      ...
      >
        ...
        <div className="mt-8">
          ...
          <div className="flex gap-6">
            ...
            <a href="tel:+1(312)-684-1792">
              <FaPhoneAlt size={32} color="white" />
            </a>
            <a href="nsatyajaidev21@gmail.com">
              <FaEnvelope size={32} color="white" />
            </a>
            <a href="https://maps.google.com/?q=Your+Address+Location" target="_blank" rel="noopener noreferrer">
